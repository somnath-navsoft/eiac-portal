  ...
  { path: 'dashboard',canActivate: [AuthGuard], 
    ...
    { path: 'cab_client', component: CabComponent, canActivate: [AuthGuard],  
      children:[
        ...
        { path: 'training-inpremise-form', component:CabTrainingInpremiseCourseComponent, canActivate: [AuthGuard] },
        { path: 'training-inpremise-form/:id', component:CabTrainingInpremiseCourseComponent, canActivate: [AuthGuard] },
