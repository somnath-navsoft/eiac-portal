...
@Component({
  selector: 'app-operations-trainer-service',
  templateUrl: './operations-trainer-service.component.html',
  styleUrls: ['./operations-trainer-service.component.scss'],
  providers: [Constants, AppService, ToastrService, Overlay, OverlayContainer]
})
export class OperationsTrainerServiceComponent implements OnInit, OnDestroy {
                      ...
                      if(data != undefined && data.records != undefined){
                        ...
                        if(data.records.customCourseListDetails != undefined && data.records.customCourseListDetails.length > 0){
                          ...
                          this.headerSteps.push(
                            ...
                            {
                            title:'payment', desc:'2. Payment <br> Information', activeStep:false, stepComp:true, active:'user-done', nextStep:null
                            }
                          );
            ...
            .subscribe(
              result => { 
               ...
               if(data && data.status == 200 && data.response === 'success'){   
                 ...
                 this._router.navigateByUrl('/dashboard/operations/training-service');
               }
             }
          ))
        }
