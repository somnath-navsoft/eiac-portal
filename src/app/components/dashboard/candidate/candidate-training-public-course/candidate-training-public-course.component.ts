...
@Component({
  selector: 'app-candidate-training-public-course',
  templateUrl: './candidate-training-public-course.component.html',
  styleUrls: ['./candidate-training-public-course.component.scss'],
  providers: [Constants, AppService, ToastrService, Overlay, OverlayContainer] 
})
export class CandidateTrainingPublicCourseComponent implements OnInit {
