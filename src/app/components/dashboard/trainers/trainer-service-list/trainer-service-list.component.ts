...
@Component({
  selector: 'app-trainer-service-list',
  templateUrl: './trainer-service-list.component.html',
  styleUrls: ['./trainer-service-list.component.scss']
})
export class TrainerServiceListComponent implements OnInit, OnDestroy {
