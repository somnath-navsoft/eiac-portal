...
@Component({
  selector: 'app-trainers-attendance-list',
  templateUrl: './trainers-attendance-list.component.html',
  styleUrls: ['./trainers-attendance-list.component.scss'],
  providers: [
...
export class TrainersAttendanceListComponent implements OnInit, OnDestroy {
